...
; 0000 002B // Function: Bit7=In Bit6=In Bit5=In Bit4=In Bit3=Out Bit2=In Bit1=In Bit0=In
; 0000 002C DDRB=(0<<DDB7) | (0<<DDB6) | (0<<DDB5) | (0<<DDB4) | (1<<DDB3) | (0<<DDB2) | (0<<DDB1) | (0<<DDB0);
	LDI  R30,LOW(8)
	OUT  0x17,R30
; 0000 002D // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=T Bit1=T Bit0=T
...
; 0000 003E // Clock value: 8000.000 kHz
; 0000 003F // Mode: CTC top=OCR0
; 0000 0040 // OC0 output: Toggle on compare match
; 0000 0041 // Timer Period: 0.125 us
; 0000 0042 // Output Pulse(s):
; 0000 0043 // OC0 Period: 0.25 us Width: 0.125 us
; 0000 0044 TCCR0=(0<<WGM00) | (0<<COM01) | (1<<COM00) | (1<<WGM01) | (0<<CS02) | (0<<CS01) | (1<<CS00);
	LDI  R30,LOW(25)
	OUT  0x33,R30
...
; 0000 008D lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 008E 
; 0000 008F /**void writeOnLcd (char[] word)
; 0000 0090 {
; 0000 0091     lcd_puts(word);
; 0000 0092 
; 0000 0093 
; 0000 0094 }**/
; 0000 0095 
...
; 0000 009C             lcd_init(20);
	LDI  R26,LOW(20)
	RCALL _lcd_init
; 0000 009D             lcd_gotoxy(xi, yi);
	LDD  R30,Y+2
	ST   -Y,R30
	LDD  R26,Y+1
	RCALL _lcd_gotoxy
; 0000 009E             lcd_puts("hello") ;
	__POINTW2MN _0x9,0
	RCALL _lcd_puts
; 0000 009F             xi ++ ;
	LDD  R30,Y+2
